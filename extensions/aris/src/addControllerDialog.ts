...
export class AddControllerDialog {
	...
	private prefilledUrl: string;
	private prefilledUsername: string;

	public setDefaultValues(url: string, username: string): void {
	...
	private createDialog(): void {
		...
		this.dialog.registerContent(async view => {
			...
			this.urlInputBox = this.modelBuilder.inputBox()
				.withProperties<azdata.InputBoxProperties>({ placeHolder: 'url', value: this.prefilledUrl }).component();
			...
			this.usernameInputBox = this.modelBuilder.inputBox()
				.withProperties<azdata.InputBoxProperties>({ placeHolder: 'username', value: this.prefilledUsername }).component();
			...
			this.rememberPwCheckBox = this.modelBuilder.checkBox()
				.withProperties<azdata.CheckBoxProperties>({ label: 'Remember Password' }).component();
